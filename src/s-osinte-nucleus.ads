...
package System.OS_Interface is
   ...
   --  The Get_Page_Size constant is also used for rounding up stack sizes,
   --  and therefore should be a positive multiple of the stack alignment.

   Get_Page_Size : constant := 32;
   PROT_ON       : constant := 0;
   PROT_OFF      : constant := 0;
