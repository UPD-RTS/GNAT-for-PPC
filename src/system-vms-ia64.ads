...
private
   ...
   pragma Ident ("GNAT Pro 2011"); --  Gnat_Static_Version_String
   --  Default ident for all VMS images. <version> gets replaced nightly by
   --  cron-src script, e.g. 6.4.0w for the actual build.
