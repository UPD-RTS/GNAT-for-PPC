...
package System.BB.Interrupts is
   ...
   Max_Interrupt : constant := System.BB.Parameters.Interrupt_IDs;
   ...
   Priority_Of_Interrupt : constant System.Any_Priority :=
   ...
   --  handled on the current CPU (if any). In case no hardware interrupt
   --  is being handled the returned value is No_Interrupt.
