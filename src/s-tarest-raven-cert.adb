...
package body System.Tasking.Restricted.Stages is
   ...
   begin
      ...
      while C /= null loop
         ...
         --  Note: pragma Cpu is not supported in VxWorks Ravenscar/cert
         --  profile. All tasks are statically assigned to the first CPU.
         ...
         Task_Primitives.Operations.Create_Task
           (T          => C,
            ...
            Base_CPU   => System.Multiprocessors.CPU'First,
            Succeeded  => Success);
