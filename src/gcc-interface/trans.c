      ...
      Entity_Id standard_exception_type, Int gigi_operating_mode)
{
  ...
  init_gnat_to_gnu ();
  init_dummy_type ();
  add_sco_tree_code (STMT_STMT, false, true, "", "", "s");
  add_sco_tree_code (LOOP_STMT, false, false, "W", "W", "dSSx");
  add_sco_tree_code (EXIT_STMT, false, false, "E", "E", "dx");
...
call_to_gnu (Node_Id gnat_node, tree *gnu_result_type_p, tree gnu_target)
{
  ...
  gnu_actual_list = nreverse (gnu_actual_list);
  gnu_call
    = build_call_list (gnu_result_type, gnu_subprog_addr, gnu_actual_list);
